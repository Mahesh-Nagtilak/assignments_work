package com.cybage.feedback.controller;
...
import com.cybage.feedback.service.FeedbackService;
...
public class FeedbackController {
	...
	public ResponseEntity<?> getAllFeedbacks() {
		...
		;
		 List<FeedBackResponse> backResponses= feedbackService.findAllFeedback();

		if (backResponses == null)
			return new ResponseEntity<>("No Feedback Found", HttpStatus.NOT_FOUND);
		return new ResponseEntity<>(backResponses, HttpStatus.OK);
	...
	public ResponseEntity<?> deleteFeedback(@PathVariable int feedbackId){
		if (!feedbackService.deleteFlightFeedBackById(feedbackId)) {
			return new ResponseEntity<>("feedback id not find to delete" , HttpStatus.NOT_FOUND);
		}
